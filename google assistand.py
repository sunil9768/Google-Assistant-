...
r=sr.Recognizer()
booting=['hello']
greetings=["hello","hello there","Hi,I am Scarlet","What is up user","Greetings human","Your wish is my command","Hello user","Hello user,what would you like to do"] 
...
def youtube(data):
    ...
    engine.runAndWait()    
    webbrowser.get("firefox").open("http://youtube.com")
...
def Gmail(data):
        ...
        engine.runAndWait
        webbrowser.get("firefox").open("http://gmail.com")
        main()
def Amazon(data):
        engine.say("Opening Amazon to purchase "+data.split('buy',1)[1])
        engine.runAndWait
        webbrowser.get("firefox").open("https://www.amazon.com/s/field-keywords=",data.split('buy',1)[1])
        main()
def SS():
...
def locate (data):
        ...
        engine.runAndWait()
        webbrowser.get("firefox").open("https://www.google.ca/maps/place/"+place+"/")
        main()
